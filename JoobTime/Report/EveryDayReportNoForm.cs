...
namespace JoobTime
{
    public partial class EveryDayReportNoForm : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private string GetTheBoss()
        {
            ...
            switch (formLogin.subunit)
            {
                ...
                case "1020": return "Павлов А.Л.";
                case "1015": return "Лазарчук А.С.";
                case "1022": return "Пилипчук В.С.";
                    default:
                        return "Степанчук А.М.";
            }
        }
