...
namespace JoobTime
{
    public class work_noform_rep : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public work_noform_rep()
        {
            ...
            xrLabel14.Text = "Отчет о работе не связанной с разработкой форм c " + Convert.ToDateTime(ReportGenerating.startDate).ToShortDateString() + " по " + Convert.ToDateTime(ReportGenerating.endDate).ToShortDateString() + "\n" + ReportGenerating.subunit_for_report + " " + ReportGenerating.fio_for_report; ;
        ...
        private void InitializeComponent()
        {
            ...
            this.xrLabel14.Text = "Отчет о проделанных работах";
            ...
            this.xrLabel6.Text = "Время работы";
            ...
            this.xrLabel1.Text = "Описание работы";
