...
namespace JoobTime
{
    ...
    internal static class DeclensionBLL
    {
        ...
        /// <param name="declensionCase">Падеж</param>
        /// <returns>Результат склонения</returns>
        public static string GetSNPDeclensionAS(string surname, string name, string patronimic,
                                              DeclensionCase declensionCase)
        ...
        /// <param name="declensionCase">Падеж</param>
        /// <returns>Результат склонения</returns>
        public static string GetSNPDeclensionFS(string surnameNamePatronimic, Gender gender,
                                              DeclensionCase declensionCase)
        ...
        /// <param name="declensionCase">Падеж</param>
        /// <returns>Результат склонения</returns>
        public static string GetNSDeclensionFS(string nameSurname, Gender gender, DeclensionCase declensionCase)
